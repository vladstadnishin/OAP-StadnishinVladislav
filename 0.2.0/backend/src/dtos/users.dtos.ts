...
export const userResponseSchema = z.object({                        // DTO відповіді користувача
  id: z.string().uuid(),
  fullName: z.string(),
...
export const createUserRequestSchema = z                                 // DTO створення користувача з базовою валідацією імені та email
  .object({
    fullName: z
      .string()
      .trim()
